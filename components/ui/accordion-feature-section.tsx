...
const defaultFeatures: FeatureItem[] = [
  ...
  },
  {
    ...
    description:
      "Built for modern web development with React, Next.js, and the latest shadcn/ui components. Take advantage of modern features while maintaining excellent performance.",
  },
];
