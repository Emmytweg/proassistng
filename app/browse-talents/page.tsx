      ...
      try {
        ...
        const mapped: TalentItem[] = (data ?? []).map((r: any) => {
          ...
          return {
            ...
            role: title,
            price: formatRate(r.hourly_rate ?? null, r.rate_type ?? null),
  ...
  return (
    <main className="min-h-screen bg-muted/30">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 pt-20">
        {/* Heading */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Find top Nigerian freelancers</h1>

          <p className="text-muted-foreground mt-2">
            Hire elite talent vetted for quality and reliability.
          </p>
        </div>
